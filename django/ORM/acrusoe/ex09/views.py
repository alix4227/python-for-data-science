...
def populate(request):
    ...
    return render(request, 'ex09/populate.html', {"results": results})
...
def display(request):
    ...
    return render(request, 'ex09/display.html', {"films": films, "result": result, "headers": headers})
...
def update(request):
    ...
    try:
        ...
        result = "No data available"
    return render(request, 'ex09/update.html', {"result": result, "titles": titles})
